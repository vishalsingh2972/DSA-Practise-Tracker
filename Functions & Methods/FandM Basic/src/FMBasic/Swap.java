...
public class Swap {
    ...
    static void swap(int a, int b) {
        int temp = a;
        a = b;    //we are using primitve datatypes so only value is passed here,hence making any changes here will not cause any change in the original values (present in main function above)
        b = temp;
