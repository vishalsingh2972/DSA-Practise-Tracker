import java.util.Arrays; //Method1
//Here I am selecting the maximum element and putting it at the last/end index position and so on (sorting done from right to left)
