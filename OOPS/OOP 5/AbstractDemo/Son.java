...
//    public class Son extends Parent, Parent2 { //Multiple Inheritances is not supported in Abstract Classes (Not Possible)
    public Son(int age) { //child class constructor
        super(100); //we cannot create objects of PC, so we cannot call constructor of PC directly, but we can call PC constructor indirectly via the CC constructor using super keyword in the CC constructor (like used here)
